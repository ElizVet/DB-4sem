...
insert into GROUPS   (FACULTY,  PROFESSION, YEAR_FIRST )
         values ('ИТ','1-40 01 02', 2013), --1	// ИДиП
                ('ИТ','1-40 01 02', 2012),
                ('ИТ','1-40 01 02', 2011),
                ('ИТ','1-40 01 02', 2010),
...
(   
	IDPAIR	integer,
	WEEK_DAY	char(20),
	IDGROUP  integer constraint TIMETABLE_GROUPS_FK foreign key
								references GROUPS(IDGROUP),
	...
	constraint IDPAIR_WEEK_DAY_PK  primary key (IDPAIR, WEEK_DAY)
 )

insert into TIMETABLE   (IDPAIR, IDGROUP,  AUDITORIUM, SUBJECT, TEACHER, WEEK_DAY)      
values 
(1, 13, '206-1', 'КМС', 'АКНВЧ', 'Понедельник'),
(2, 13, '206-1', 'ИГ', 'БРГ', 'Понедельник'),

(1, 10, '206-1', 'ИГ', 'БРГ', 'Среда'),
(2, 12, '206-1', 'ЛВ', 'БРКВЧ', 'Среда'),
(3, 12, '206-1', 'ЛВ', 'БРКВЧ', 'Среда'),

(2, 8, '236-1', 'ООП', 'БЗБРДВ', 'Вторник'),
(3, 4, '236-1', 'КМС', 'АКНВЧ', 'Вторник'),
(4, 6, '236-1', 'ИГ', 'БРГ', 'Вторник'),

(4, 3, '236-1', 'ЛВ', 'БРКВЧ', 'Четверг');